    ...
    <div className="min-h-screen bg-slate-900">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-6 text-slate-300 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-white text-lg font-semibold mb-2">5. Data Deletion</h2>
            <p>You may request deletion of your account and all associated data at any time by emailing <a href="mailto:support@peptidetracker.app" className="text-indigo-400 hover:underline">support@peptidetracker.app</a>. We will process your request within 30 days.</p>
          </section>

          <section>
            <h2 className="text-white text-lg font-semibold mb-2">6. Health Disclaimer</h2>
          ...
          <section>
            ...
            <p>Questions? Email us at <a href="mailto:privacy@peptidetracker.app" className="text-indigo-400 hover:underline">privacy@peptidetracker.app</a></p>
          </section>
        </div>
      </div>
    </div>
