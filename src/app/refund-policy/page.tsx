  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        ['How', 'Email us with your order reference (the four-character code from checkout). We confirm within one business day and refund the way you paid — to your Zelle account or your wallet.'],
