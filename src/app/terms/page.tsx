    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <div className="space-y-6 text-[#3A3730] text-sm leading-relaxed">
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">1. Acceptance of Terms</h2>
            <p>By using PeptideTracker, you agree to these Terms of Service. If you do not agree, do not use the service.</p>
          </section>

          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">2. Educational Use Only</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">3. Account Eligibility</h2>
            <p>You must be 18 years or older to use PeptideTracker. By creating an account, you confirm you meet this requirement.</p>
          </section>

          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">4. Subscriptions & Billing</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">5. Prohibited Use</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">6. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">7. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">8. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-[#1A1915] text-lg font-semibold mb-2">9. Contact</h2>
            <p>Legal questions: <a href="mailto:legal@peptidetracker.app" className="text-[#1A8A9E] hover:underline">legal@peptidetracker.app</a></p>
          </section>
        </div>
      </div>
    </div>
