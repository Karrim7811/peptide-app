...
export interface Compound {
  ...
  stacksWith: string[]
  /**
   * Where the entry came from. Absent on the 92 ported from the master
   * spreadsheet; 'researched' on entries whose fields were traced to a named
   * trial or drug label rather than carried over from the sheet.
   */
  sourced?: 'researched'
}
...
/**
 * A physical vial you hold, as printed on its label.
 *
 * Batch facts only. What the compound IS lives on `Compound`; what you do with
 * it lives on `StackEntry`. A vial knows neither — it knows which lot it came
 * from, what the assay said, and when it stops being good.
 *
 * Ported by hand from design/vial-labels/peptides.json, the same source the
 * label generator prints artwork from. Nothing regenerates this at build time,
...
export interface Vial {
  ...
  /** The compound name as printed on the label. */
  label: string
  qty: number
  unit: 'mg' | 'IU'
  /** Assayed purity as a percentage. Null where the batch was never assayed. */
  purity: number | null
  lot: string
  /** YYYY-MM. Null where the label went out undated — see catalog.test.ts. */
  mfg: string | null
  exp: string | null
  shelfLife: string
...
export interface Counts {
  ...
  categories: number
  stack: number
  /** Physical vials in VIALS — batches held, not compounds known. */
  vials: number
}
...
export const COMPOUNDS: Record<string, Compound> = {
 ...
 "slu-pp-332": {
  "id": "slu-pp-332",
  "name": "SLU-PP-332",
  "fullName": "SLU-PP-332 (ERR pan-agonist)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight",
  "action": "Pan-agonist of the estrogen-related receptors ERRα/β/γ; induces the acute aerobic-exercise transcriptional programme in skeletal muscle in an ERRα-dependent way.",
  "effects": "Studied as an \"exercise mimetic\". In mice, raised energy expenditure and fatty-acid oxidation, less fat-mass accumulation and improved insulin sensitivity.",
  "dosage": "No human dose exists. Rodent work used 30–50 mg/kg intraperitoneally twice daily for 12–28 days. There is no human pharmacokinetic data to scale from.",
  "cautions": "Never given to a human in a registered trial. No safety, toxicity or pharmacokinetic data in people at any dose.",
  "interactions": "No human interaction data exists.",
 ...
 "adipotide-ftpp": {
  "id": "adipotide-ftpp",
  "name": "Adipotide",
  "fullName": "Adipotide (FTPP, prohibitin-targeting peptide-1)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight",
  "action": "Targets prohibitin on the vasculature supplying white adipose tissue, triggering apoptosis of those vessels and so of the fat they feed.",
  "effects": "In obese rhesus macaques, roughly 11% body-weight reduction over 28 days with improved insulin sensitivity.",
  "dosage": "No human dose was ever established. Phase 1 dosing in obese prostate-cancer patients began in 2012; the study was terminated and the programme discontinued in 2019 on dose-limiting kidney toxicity, with no maximum tolerated dose published. The 0.43 mg/kg/day figure that circulates is the macaque dose, not a human one.",
  "cautions": "Dose-limiting nephrotoxicity ended clinical development — raised creatinine and structural change in renal tubular cells. The therapeutic window between fat loss and kidney injury was too narrow for clinical use. Renal toxicity that looked mild and reversible in animals did not stay that way in humans.",
  "interactions": "No human interaction data. Any concurrent nephrotoxic agent compounds the known dose-limiting toxicity.",
 ...
 "lemon-bottle": {
  "id": "lemon-bottle",
  "name": "Lemon Bottle",
  "fullName": "Lemon Bottle (lipolytic injection solution)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight",
  "action": "Marketed as an injectable lipolytic solution; the manufacturer lists riboflavin (vitamin B2) among the actives, whose role in fat breakdown by injection is theoretical rather than established.",
  "effects": "Marketed for dissolving localised pockets of fat. No independent peer-reviewed randomised trial supports the formulation.",
  "dosage": "No established dose. The formulation has never been through a published dose-finding study.",
  "cautions": "The FDA issued a warning letter in March 2025 over US sale of Lemon Bottle and similar injectables as unapproved new drugs. Reported complications include injection-site infection, skin necrosis, persistent nodules, asymmetric contouring, permanent scarring and allergic reaction.",
  "interactions": "Composition is not fully disclosed, so interactions cannot be assessed.",
 ...
 "hgh-fragment-176-191": {
  ...
  "fullName": "Human Growth Hormone Fragment 176-191",
  "category": "GH Axis",
  "catId": "gh-axis",
  "purpose": "GH Axis / Fat metabolism",
  "action": "The C-terminal lipolytic domain of human growth hormone, isolated from the rest of the molecule so that fat-metabolism effects are separated from GH growth signalling.",
  "effects": "Studied for lipolysis without the insulin-resistance and glucose-intolerance seen with full-length growth hormone.",
  "dosage": "The unmodified fragment has not been studied in humans and has no established dose. Its modified analogue AOD-9604 used 1 mg/day in 12- and 23-week obesity trials; those produced about 2.6–2.8 kg of weight loss against 0.8 kg on placebo, but the Phase IIb trial missed its primary endpoint and development for obesity stopped around 2007.",
  "cautions": "No human data on the unmodified fragment. Injection-site reactions reported. Do not read AOD-9604 trial results as evidence for this molecule.",
  "interactions": "No human interaction data for the unmodified fragment.",
 ...
 "ace-031": {
  "id": "ace-031",
  "name": "ACE-031",
  "fullName": "ACE-031 (ramatercept, soluble ActRIIB-Fc)",
  "category": "Muscle/Performance",
  "catId": "muscle-performance",
  "purpose": "Muscle / Performance",
  "action": "A soluble decoy receptor built from the extracellular domain of activin receptor type IIB fused to an antibody Fc, binding myostatin and related ligands before they reach their receptor.",
  "effects": "Increased muscle mass in humans. That much it did do.",
  "dosage": "No established dose. A Phase 2 dose-escalation study in ambulatory boys with Duchenne muscular dystrophy was stopped after the second dosing regimen, the extension study suspended, and the whole programme discontinued in 2013. No dose was carried forward.",
  "cautions": "Development was halted for vascular bleeding effects: epistaxis, gum bleeding and telangiectasia. The wild-type ActRIIB-Fc also blocks BMP9 signalling, which maintains blood-vessel homeostasis, and that is the suspected cause. The muscle gain was real; the programme was stopped anyway.",
  "interactions": "No human interaction data. Concurrent anticoagulant or antiplatelet therapy compounds the known bleeding signal.",
 ...
 "ahk-cu": {
  "id": "ahk-cu",
  "name": "AHK-Cu",
  "fullName": "AHK-Cu (copper tripeptide-3, Ala-His-Lys-Cu)",
  "category": "Skin/Hair",
  "catId": "skin-hair",
  "purpose": "Skin / Hair",
  "action": "Copper-binding tripeptide studied for hair-follicle elongation and dermal papilla cell proliferation.",
  "effects": "Stimulated elongation of human hair follicles ex vivo and proliferation of dermal papilla cells in vitro.",
  "dosage": "No FDA-approved human dose. Topical cosmetic formulations run roughly 0.5–2% by weight, with patents claiming 0.1–20%. The ex vivo follicle work used 10⁻¹²–10⁻⁹ M, which is not a topical concentration.",
  "cautions": "Scalp and skin irritation. Human efficacy data is limited; the follicle findings are ex vivo, not from a clinical trial.",
  "interactions": "No systematic interaction data. Copper peptides are conventionally kept apart from direct-acid and high-strength vitamin C formulations in topical routines.",
 ...
 "cartalax": {
  "id": "cartalax",
  "name": "Cartalax",
  "fullName": "Cartalax (AED tripeptide bioregulator)",
  "category": "Healing/Recovery",
  "catId": "healing-recovery",
  "purpose": "Healing / Connective tissue",
  "action": "Ala-Glu-Asp tripeptide from the Khavinson bioregulator family, studied for cartilage and connective-tissue signalling.",
  "effects": "Studied for cartilage and connective tissue. Evidence is preclinical plus one small unregistered human study.",
  "dosage": "No clinical-trial-established dose. Community protocols run 1–2 mg/day subcutaneously or 10–20 mg/day orally in 10–20 day cycles, two to three times a year. Those figures come from user practice, not from a trial.",
  "cautions": "One small unregistered human study (n=29, knee osteoarthritis) and preclinical work. No validated clinical use, and essentially no independent Western trial data.",
  "interactions": "No interaction data published.",
 ...
 "glutathione": {
  "id": "glutathione",
  "name": "Glutathione",
  "fullName": "Glutathione (GSH, reduced L-glutathione)",
  "category": "Skin/Hair",
  "catId": "skin-hair",
  "purpose": "Antioxidant / Skin",
  "action": "Endogenous tripeptide antioxidant; injected forms are marketed for skin lightening on the premise of shifting melanin synthesis from eumelanin toward pheomelanin.",
  "effects": "Widely used for skin brightening and marketed for detoxification. No published clinical trial has evaluated injectable glutathione for skin lightening.",
  "dosage": "No published dosing guideline exists for injectable use, and no trial has established a regimen or duration. Sources describing a narrow window between an effective dose and a toxic one are describing an absence of data, not a protocol.",
  "cautions": "The FDA has not approved glutathione for skin lightening and has warned against intravenous use for that purpose. Reported harms include anaphylaxis, hepatotoxicity, renal and neurological toxicity, and Stevens-Johnson syndrome. Shifting melanin type may raise sun-induced skin-cancer risk in previously protected skin.",
  "interactions": "No systematic interaction data for injectable use.",
 ...
 "foxo4-dri": {
  ...
  "category": "Longevity",
  "catId": "longevity",
  "purpose": "Longevity / Senolytic",
  "action": "A D-retro-inverso peptide that disrupts the FOXO4-p53 interaction, releasing p53 to trigger apoptosis selectively in senescent cells.",
  "effects": "In naturally aged mice, restored fur density, improved renal function and raised activity. Cleared senescent human chondrocytes in vitro.",
  "dosage": "No human dose exists. Mouse work used 5 mg/kg intraperitoneally for three doses. No pharmacokinetic study has been published in any species.",
  "cautions": "Never tested in humans. No human pharmacokinetic or safety data at any dose. Its mechanism is deliberate induction of p53-driven apoptosis, which is not a mechanism to approach without dose-finding data.",
  "interactions": "No interaction data exists in any species.",
 ...
 "vesugen": {
  "id": "vesugen",
  "name": "Vesugen",
  "fullName": "Vesugen (KED tripeptide bioregulator)",
  "category": "Cardio/Vascular",
  "catId": "cardio-vascular",
  "purpose": "Vascular bioregulator",
  "action": "Lys-Glu-Asp tripeptide from the Khavinson family, studied for vascular-tissue signalling.",
  "effects": "Studied for blood-vessel tissue maintenance.",
  "dosage": "No clinical-trial-established dose. Reported practice is 20 mg/day orally or 2–3 mg/day injected. These are community figures, not trial doses.",
  "cautions": "Evidence is Russian observational and preclinical work from one research group. Independent Western clinical trials are essentially absent.",
  "interactions": "No interaction data published.",
 ...
 "cardiogen": {
  "id": "cardiogen",
  "name": "Cardiogen",
  "fullName": "Cardiogen (AEDR tetrapeptide bioregulator)",
  "category": "Cardio/Vascular",
  "catId": "cardio-vascular",
  "purpose": "Cardiac bioregulator",
  "action": "Ala-Glu-Asp-Arg tetrapeptide from the Khavinson family, studied for cardiac-tissue signalling.",
  "effects": "Studied for heart tissue and cardiovascular ageing.",
  "dosage": "No clinical-trial-established human dose. Published research is preclinical and mechanistic from a single research group.",
  "cautions": "No validated clinical use. Evidence base is one group’s preclinical work plus Russian observational reports.",
  "interactions": "No interaction data published.",
 ...
 "cortagen": {
  "id": "cortagen",
  "name": "Cortagen",
  "fullName": "Cortagen (AEDP tetrapeptide bioregulator)",
  "category": "Cognition/Mood",
  "catId": "cognition-mood",
  "purpose": "Neuro / Connective bioregulator",
  "action": "Ala-Glu-Asp-Pro tetrapeptide from the Khavinson family, studied for nervous-system and connective-tissue signalling.",
  "effects": "Studied for nerve and connective-tissue repair and for cognitive decline in the Russian literature.",
  "dosage": "No clinical-trial-established dose. Reported practice is 20 mg/day orally or 2–5 mg/day injected. Community figures, not trial doses.",
  "cautions": "Evidence is Russian observational and animal work. Independent Western trials are essentially absent.",
  "interactions": "No interaction data published.",
 ...
 "adamax": {
  "id": "adamax",
  "name": "Adamax",
  "fullName": "Adamax (N-acetyl adamantyl Semax analogue)",
  "category": "Cognition/Mood",
  "catId": "cognition-mood",
  "purpose": "Nootropic / Neuro",
  "action": "A Semax (ACTH 4-10) analogue carrying an N-terminal acetyl group and a C-terminal adamantane, intended to resist proteolysis and improve cellular uptake.",
  "effects": "Proposed to act on BDNF and TrkB signalling by analogy with Semax, which raises BDNF and NGF-related signalling in animal models.",
  "dosage": "No dose has been established, because the molecule itself has no published studies. Any figure in circulation is extrapolated from Semax.",
  "cautions": "A literature search returns no dedicated peer-reviewed human trials and effectively no published preclinical work on the modified molecule. Whether the adamantane modification improves on Semax in humans is simply unknown. Sold for laboratory research only.",
  "interactions": "No interaction data exists.",
 ...
 "pe-22-28": {
  "id": "pe-22-28",
  "name": "PE 22-28",
  "fullName": "PE 22-28 (shortened spadin analogue)",
  "category": "Cognition/Mood",
  "catId": "cognition-mood",
  "purpose": "Nootropic / Mood",
  "action": "A synthetic heptapeptide derived from spadin that blocks the TREK-1 potassium channel, with an IC₅₀ of about 0.12 nM against spadin’s 40–60 nM.",
  "effects": "Antidepressant-like effects in rodent behavioural models, with in vivo stability extended to roughly 23 hours against spadin’s 7.",
  "dosage": "No human dose established; no registered human trial has been completed. Reported practice is 100–300 mcg intranasally or subcutaneously once daily, which is community usage rather than a studied regimen.",
  "cautions": "All efficacy evidence is from rodent models. Not approved for any use, and no human safety or pharmacokinetic data exists.",
  "interactions": "No human interaction data. TREK-1 blockade overlaps mechanistically with serotonergic antidepressant pathways, which has not been studied in combination.",
 ...
 "botulinum-toxin": {
  ...
  "fullName": "Botulinum Toxin Type A (Botox, onabotulinumtoxinA)",
  "category": "GI/Bone/Other",
  "catId": "gi-bone-other",
  "purpose": "Neuromuscular",
  "action": "Cleaves SNAP-25 at the presynaptic terminal, blocking acetylcholine release and so neuromuscular transmission at the injected site.",
  "effects": "Localised, reversible muscle relaxation. Used for spasticity, chronic migraine, overactive bladder, hyperhidrosis and cosmetic indications.",
  "dosage": "Dose is specific to indication and expressed in Units that are NOT interchangeable between botulinum toxin products. The label gives, for example, 100 Units total for overactive bladder across 20 detrusor sites, and 4–8 Units/kg to a maximum of 300 Units for paediatric lower-limb spasticity. Administration is a clinical procedure, not a self-directed one.",
  "cautions": "Contraindicated in hypersensitivity to any botulinum toxin preparation and in infection at the injection site. Carries a boxed warning for distant spread of toxin effect. Units are product-specific and confusing them is a dosing error, not a rounding difference.",
  "interactions": "Co-administration with aminoglycosides or other agents interfering with neuromuscular transmission, such as curare-like compounds, may potentiate the toxin’s effect and should be approached with caution. No formal interaction studies have been conducted.",
 ...
 "vitamin-b12": {
  ...
  "category": "GI/Bone/Other",
  "catId": "gi-bone-other",
  "purpose": "Support / Adjunct",
  "action": "Cofactor for methionine synthase and methylmalonyl-CoA mutase; required for haematopoiesis, myelin maintenance and homocysteine metabolism.",
  "effects": "Corrects deficiency. Injected forms bypass the intrinsic-factor absorption pathway, which is what makes them useful in pernicious anaemia.",
  "dosage": "For pernicious anaemia the labelled regimen is 30–50 mcg intramuscularly or subcutaneously daily for at least two weeks to a total of 1,000–5,000 mcg, then 100 mcg monthly as maintenance. Higher single doses are common in practice.",
  "cautions": "Generally well tolerated. Mild injection-site pain and rare allergic reaction. Supplementation can mask the haematological signs of deficiency while neurological damage progresses, so a documented B12 level before treatment matters.",
  "interactions": "Metformin reduces B12 absorption by interfering with calcium-dependent intrinsic-factor binding; subnormal levels appeared in about 7% of metformin patients in trials, and B12 should be measured every two to three years on long-term therapy. Proton-pump inhibitors and H2 blockers also reduce absorption.",
 ...
 "l-carnitine": {
  "id": "l-carnitine",
  "name": "L-Carnitine",
  "fullName": "L-Carnitine (levocarnitine, Carnitor)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Energy",
  "action": "Transports long-chain fatty acids across the inner mitochondrial membrane for beta-oxidation.",
  "effects": "Corrects primary and secondary carnitine deficiency, its labelled indication. Marketed far more widely for fat metabolism and exercise performance.",
  "dosage": "The FDA-approved oral dose for carnitine deficiency is 990 mg two or three times daily using 330 mg tablets; oral solution is 1–3 g/day for a 50 kg patient, started at 1 g/day and titrated against tolerance.",
  "cautions": "Nausea, stomach upset, and a fishy body odour at higher doses. The cardiovascular picture is genuinely unsettled — see CV notes before using it long term.",
  "interactions": "No major drug interactions at labelled doses. The clinically relevant interaction is with the gut microbiome, which converts carnitine to TMAO.",
 ...
 "bacteriostatic-water": {
  ...
  "fullName": "Bacteriostatic Water for Injection, USP (0.9% benzyl alcohol)",
  "category": "GI/Bone/Other",
  "catId": "gi-bone-other",
  "purpose": "Reconstitution solvent",
  "action": "Not a peptide. Sterile water containing 0.9% benzyl alcohol as a bacteriostatic preservative, which is what permits multi-dose vial use.",
  "effects": "Reconstitutes lyophilised compounds. The preservative is the entire functional difference from Sterile Water for Injection, which is preservative-free and single-use only.",
  "dosage": "Not dosed. Volume is set by the reconstitution being prepared, not by the diluent.",
  "cautions": "Contraindicated in neonates. Benzyl alcohol accumulates in newborns, whose metabolic pathways cannot clear it, causing metabolic acidosis and respiratory failure — the fatal \"gasping syndrome\". Preservative-free Sterile Water for Injection is required for neonatal preparations. Never inject undiluted; plain water is hypotonic and causes haemolysis.",
  "interactions": "Benzyl alcohol is incompatible with some compounds and preparations. Confirm diluent compatibility for the specific compound being reconstituted.",
 ...
 "orforglipron": {
  "id": "orforglipron",
  "name": "Orforglipron",
  "fullName": "Orforglipron (Foundayo, oral GLP-1)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight loss",
  "action": "Non-peptide small-molecule GLP-1 receptor agonist taken orally, with no food, water or timing restriction — the property that separates it from oral semaglutide.",
  "effects": "Appetite reduction and weight loss from a daily tablet. In ATTAIN-1, participants on the highest dose who stayed on treatment lost about 12.4% of body weight against 0.9% on placebo.",
  "dosage": "Oral tablets at 0.8 mg, 2.5 mg and 5.5 mg, titrated upward to the tolerated dose. Approved by the FDA in April 2026 for chronic weight management in adults with obesity, or overweight with a weight-related condition.",
  "cautions": "Boxed warning for thyroid C-cell tumours. Nausea, diarrhoea, constipation and indigestion are common, worst on starting or escalating, and settle over time. Pancreatitis and hypoglycaemia are less common but need prompt attention.",
  "interactions": "As a GLP-1 agonist, caution with insulin and sulfonylureas for hypoglycaemia risk. Delayed gastric emptying can affect absorption of oral medications.",
 ...
 "amycretin": {
  "id": "amycretin",
  "name": "Amycretin",
  "fullName": "Amycretin (zenagamtide, GLP-1/amylin)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight loss",
  "action": "Single molecule with both GLP-1 and amylin receptor agonism, in subcutaneous and oral formulations.",
  "effects": "In a Phase Ib/IIa trial, 22% average weight reduction at the 20 mg weekly subcutaneous dose over 36 weeks against roughly 2% weight gain on placebo — and weight loss had not plateaued at week 36.",
  "dosage": "No approved dose. Phase Ib/IIa used up to 20 mg once weekly subcutaneously for 36 weeks; a Phase 3 programme was planned to begin in early 2026. Not available outside a trial.",
  "cautions": "Investigational. GI effects consistent with the GLP-1 class. Long-term safety is not established, and the Phase 3 programme has not read out.",
  "interactions": "Expected to follow the GLP-1 class: caution with insulin and sulfonylureas, and delayed gastric emptying affecting oral drug absorption. Not formally studied.",
 ...
 "aleniglipron": {
  "id": "aleniglipron",
  "name": "Aleniglipron",
  "fullName": "Aleniglipron (GSBR-1290, oral GLP-1)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight loss",
  "action": "Daily oral small-molecule GLP-1 receptor agonist.",
  "effects": "About 15.3% weight loss reported in trial. Across all studies to date there were no cases of drug-induced liver injury, no persistent liver enzyme elevation and no QTc prolongation.",
  "dosage": "No approved dose. The Phase 3 design starts titration at 2.5 mg with the intent to evaluate doses up to 240 mg; the Phase 2b open-label extension titrates monthly to a 120 mg target.",
  "cautions": "Investigational and not approved. GI effects consistent with the class. Over 200 patients treated without serious adverse events, but Phase 3 has not read out.",
  "interactions": "Expected GLP-1 class behaviour; not formally studied.",
 ...
 "danuglipron": {
  "id": "danuglipron",
  "name": "Danuglipron",
  "fullName": "Danuglipron (PF-06882961, discontinued)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight loss",
  "action": "Oral small-molecule GLP-1 receptor agonist.",
  "effects": "Development for chronic weight management was discontinued by Pfizer before any approval.",
  "dosage": "No dose was established for use. The programme was discontinued; nothing was carried forward.",
  "cautions": "Discontinued over a liver safety signal. Across a safety database of more than 1,400 participants, liver enzyme elevations were in line with approved agents in the class, but one asymptomatic participant experienced potential drug-induced liver injury, which resolved on stopping the drug.",
  "interactions": "Not applicable; the compound is not in use.",
 ...
 "tesofensine": {
  "id": "tesofensine",
  "name": "Tesofensine",
  "fullName": "Tesofensine (Nupenta, Tesomet)",
  "category": "Metabolic/Weight",
  "catId": "metabolic-weight",
  "purpose": "Metabolic / Weight loss",
  "action": "Triple monoamine reuptake inhibitor, raising dopamine, serotonin and noradrenaline. Not a peptide and not an incretin — a centrally acting appetite suppressant.",
  "effects": "Phase 2 mean weight loss of 4.5% at 0.25 mg/day and 9.2% at 0.5 mg/day.",
  "dosage": "Not FDA-approved. Approved in Mexico since 2023 as Nupenta (monotherapy) and Tesomet (with metoprolol). Phase 3 planning used 0.25 and 0.5 mg/day orally.",
  "cautions": "Monoamine reuptake inhibition raises heart rate and blood pressure, which is why the Mexican combination product pairs it with a beta blocker. Not approved in the US.",
  "interactions": "Serious interaction risk with MAO inhibitors, SSRIs, SNRIs and other serotonergic or sympathomimetic agents. Coadministration with monoamine-active drugs needs specialist oversight.",
 ...
 "bimagrumab": {
  "id": "bimagrumab",
  "name": "Bimagrumab",
  "fullName": "Bimagrumab (anti-activin type II receptor antibody)",
  "category": "Muscle/Performance",
  "catId": "muscle-performance",
  "purpose": "Muscle / Lean-mass preservation",
  "action": "Monoclonal antibody against type II activin receptors, reducing fat mass while promoting muscle growth. Same receptor family as ACE-031, but an antibody rather than a decoy receptor.",
  "effects": "In the BELIEVE Phase 2b trial, bimagrumab with semaglutide reached up to 17.8 kg weight reduction against 14.2 kg for semaglutide alone, and largely preserved lean mass where semaglutide alone reduced it. At 30 mg/kg alone, lean mass rose slightly above baseline.",
  "dosage": "No approved dose. BELIEVE used 10 or 30 mg/kg at weeks 4, 16, 28 and 40 over 48 weeks, alone or with semaglutide at 1.0 or 2.4 mg weekly.",
  "cautions": "Investigational; Phase 2b only. The activin receptor pathway is the same one whose blockade ended the ACE-031 programme for bleeding effects, though bimagrumab has not shown that signal.",
  "interactions": "Studied in combination with semaglutide. No formal interaction studies otherwise.",
 ...
 "vilon": {
  "id": "vilon",
  "name": "Vilon",
  "fullName": "Vilon (Lys-Glu dipeptide)",
  "category": "Immune/Anti-inf",
  "catId": "immune-anti-inf",
  "purpose": "Immune bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from thymus and immune tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for immune modulation and tissue regeneration. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
 ...
 "thymogen": {
  "id": "thymogen",
  "name": "Thymogen",
  "fullName": "Thymogen (Glu-Trp dipeptide)",
  "category": "Immune/Anti-inf",
  "catId": "immune-anti-inf",
  "purpose": "Immune bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from thymic tissue, originally from calf thymus and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for immune function. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "livagen": {
  "id": "livagen",
  "name": "Livagen",
  "fullName": "Livagen (Lys-Glu-Asp-Ala tetrapeptide)",
  "category": "GI/Bone/Other",
  "catId": "gi-bone-other",
  "purpose": "Hepatic bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from liver tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for hepatic gene expression. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "testagen": {
  "id": "testagen",
  "name": "Testagen",
  "fullName": "Testagen (Lys-Glu-Asp-Gly tetrapeptide)",
  "category": "Sexual Health",
  "catId": "sexual-health",
  "purpose": "Reproductive bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from testicular tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for the reproductive axis. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "prostamax": {
  "id": "prostamax",
  "name": "Prostamax",
  "fullName": "Prostamax (Lys-Glu-Asp-Pro tetrapeptide)",
  "category": "Sexual Health",
  "catId": "sexual-health",
  "purpose": "Prostate bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from prostate tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for prostate function. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "chonluten": {
  "id": "chonluten",
  "name": "Chonluten",
  "fullName": "Chonluten (Glu-Asp-Gly tripeptide)",
  "category": "Immune/Anti-inf",
  "catId": "immune-anti-inf",
  "purpose": "Respiratory bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from bronchial epithelial tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for respiratory tissue and inflammatory signalling. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "endoluten": {
  "id": "endoluten",
  "name": "Endoluten",
  "fullName": "Endoluten (pineal peptide bioregulator)",
  "category": "Longevity",
  "catId": "longevity",
  "purpose": "Pineal bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from pineal tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for pineal function and ageing. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
 ...
 "cortexin": {
  "id": "cortexin",
  "name": "Cortexin",
  "fullName": "Cortexin (brain cortex peptide complex)",
  "category": "Cognition/Mood",
  "catId": "cognition-mood",
  "purpose": "Neuro bioregulator",
  "action": "Short peptide from the Khavinson bioregulator family, reverse-engineered from brain cortex tissue and proposed to act through tissue-selective gene regulation.",
  "effects": "Studied for broad neurological cell support. Evidence is preclinical and mechanistic, largely from a single research group.",
  "dosage": "No clinical-trial-established dose. Any figure in circulation comes from community practice or vendor material, not from a controlled trial.",
  "cautions": "The evidence base is Russian observational and preclinical work characterised from 1973 onwards. Independent Western clinical trials are essentially absent, so neither efficacy nor a safety profile has been established to the standard the rest of this catalog uses.",
  "interactions": "No interaction data published.",
  "bottomLine": "Organ-specific claims resting on one research tradition, with no Western clinical validation.",
...
export const COUNTS: Counts = { compounds: 124, categories: 12, stack: 6, vials: 27 };
...
/**
 * Every vial that answers to a compound — held directly, or as one component of
 * a blend. GLOW is not TB-500, but if you are reading the TB-500 page you are
 * holding some, so it counts here and the caller can tell the two apart by
 * `blendOf`.
 */
export function vialsFor(compoundId: string): Vial[] {
  return VIALS.filter(
    (vial) => vial.compoundId === compoundId || (vial.blendOf?.includes(compoundId) ?? false),
  )
}
