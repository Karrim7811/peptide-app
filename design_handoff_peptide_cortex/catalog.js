...
// Catalog generated from peptide-app/src/lib/peptide-knowledge.ts (58 entries,
// itself auto-generated from Peptides_Master_List_FULL_...xlsx). Marker keys,
// labels and units are verbatim from peptide-app/src/lib/bloodwork-markers.ts.
// Grades map ONE-TO-ONE from evidenceLevel. cvRating is a CARDIOVASCULAR score
// (paired with cvNotes) and must never influence the evidence grade; every prose field is the
// repo's own copy, unedited, so nothing prescriptive is invented here.
//
// Supabase mapping when this is wired for real:
//   STACK     -> stack_items          DOSE_LOG -> dose_logs
//   MARKERS   -> bloodwork_results    CYCLE    -> cycles
//   SITES     -> injection_sites      COMPOUNDS-> local bundle (not a table)
...
export const COUNTS = { compounds: 58, categories: 12, stack: 6 };
